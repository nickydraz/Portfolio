...
public class MazeGUI extends JFrame {
	...
	public void createBoard(int n, char[][] M)
	{
         ...
         * Depending on icon size and 
         * the size of the maze,
         * loading can take a while. 
         * 
         * Make sure the user knows
         * that the program has not frozen
         * by displaying a dialog that
         * indicates that the maze is loading.
         * 
         * On test machine, loading was 
         * extremely quick, but the wait time
         * may also change based on hardware.
         */
