...
{
	static final int SIZE = 64000000; 
	...
	static long numCalls = 0; //Number of function calls made
	static long numSwaps = 0; //Number of swaps made
   ...
   public static void main(String[] args)
   {
		...
		int[]A = new int[SIZE];
     	...
     	System.out.println("==== Nicholas Drazenovic ====");
		...
		System.out.print("The number of function calls made was: ");
		System.out.printf("%,d\n", numCalls);
		System.out.print("The number of swaps made was: ");
		System.out.printf("%,d", numSwaps);
	}// end main
