...
public class SlowSort
{
	...
	static long numComps = 0; //Number of comparisons made
    ...
    */
    public static void main(String[] args)
    {
        ...
        {	if (i % 10 == 0)    // Start a new line
		  ...
		  System.out.println("\n\nThe number of comparisons made: " + numComps);
		  System.out.println("The number of swaps made: " + numSwaps);
	...
	public static void bubbleSort()
	{
		...
		for (int pass = 1; pass < SIZE; pass++, lastToCheck--)
	   {
			...
			{
				numComps++; //Increment the number of comparisons
